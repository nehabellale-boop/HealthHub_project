...
SECRET_KEY = 'django-insecure-hospital-mgt-system-sec-key-replace-in-prod-!#987'
...
INSTALLED_APPS = [
    ...
    # Hospital Management Custom Apps
...
# Database
# Using SQLite as per specification
DATABASES = {
    'default': {
...
DEFAULT_FROM_EMAIL = 'billing@hospitalcare.com'
